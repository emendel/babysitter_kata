...
test("If end at 11:00 PM pay from midnight to end returns 0", () => {
  expect(midnightToEnd("23:00", "23:00")).toEqual(0);
});

test("If end at 01:00 AM pay from midnight to end returns 16", () => {
  expect(midnightToEnd("23:00", "01:00")).toEqual(16);
});

test("If end at 04:00 AM pay from midnight to end returns 16", () => {
  expect(midnightToEnd("23:00", "04:00")).toEqual(64);
});
...
test("max pay should return 148", () => {
  ...
  expect(midnightToEnd("17:00", "04:00")).toEqual(64);
